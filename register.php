...
} elseif (strlen($tel) < 3 or strlen($tel) > 50 or !preg_match('/^[0-9]*$/i', $tel)) {
    echo '<div class="alert alert-danger">
    Telefon måste vara mer än 2 tecken eller max 50 och bara nummer.
    </div>';
} elseif (strlen($pass) < 5 or strlen($pass) > 25) {
    echo '<div class="alert alert-danger">
    Password måste vara mer än 4 tecken eller max 50.
    </div>';
